...
public class QuatUtil {
	/**
	 * Calculates the euler angles from the quaternion, positive direction of the rotaion follows the right hand rule: if 
	 * the thumb of the right hand is pointed in the direction of the axis, the positive direction of rotation is given by
